...
from pointnet.irradiancemodel_normals import PointNetDenseCls_normals, feature_transform_regularizer
from pointnet.irradiancemodel import PointNetDenseCls
...
def fit(opt, lr, name):    
    ...
    m = dataset[0][0].shape[1] - 3
    
    classifier = PointNetDenseCls_normals(k=dataset.npoints, feature_transform=opt.feature_transform)
    ...
    for epoch in range(opt.nepoch):
        ...
        for i, data in enumerate(dataloader, 0):
            ...
            pred, trans, trans_feat = classifier(data)
